...
#ifndef TTCL_CL_WR_DATA_CLUSTERER_W_HXX
#define TTCL_CL_WR_DATA_CLUSTERER_W_HXX

/** @file
    Clustering - Data clusterer wrapper
...
namespace ttcl {
  ...
  namespace cl {
    ...
    namespace wr {
      ...
      /// Data clusterer interface
      template <typename Choices>
      class _data_clusterer_interface :
      ...
      public:
        ...
        /// Constructor
        _data_clusterer_interface(bool _owned = true,
                                  uint _references = 0) :
        ...
        hard_cluster(const dt::wr::data_wrap& _data,
                     const uint _n_clusters) const = 0;
        ...
        soft_cluster(const dt::wr::data_wrap& _data,
                     const uint _n_clusters) const = 0;
      };

      /// Data clusterer referee
      template <typename T,
                typename Interface>
      class _data_clusterer_referee :
      ...
      public:
        /// Constructor
        _data_clusterer_referee(T* _ptr = 0, bool _owned = true) :
        ...
        hard_cluster_on(hard_clustering_type& _hard_clustering,
          ...
          // Call
          this->ptr_->hard_cluster_on(_hard_clustering, *data, _n_clusters);
        }
        ...
        hard_cluster(const dt::wr::data_wrap& _data,
          ...
          // Call
          return this->ptr_->hard_cluster(*data, _n_clusters);
        }
        ...
        soft_cluster_on(soft_clustering_type& _soft_clustering,
          ...
          // Call
          this->ptr_->soft_cluster_on(_soft_clustering, *data, _n_clusters);
        }
        ...
        soft_cluster(const dt::wr::data_wrap& _data,
          ...
          // Call
          return this->ptr_->soft_cluster(*data, _n_clusters);
        }
      };

      /// Base data clusterer wrapper
      template <typename Interface>
      class _data_clusterer_w :
      ...
      protected:
        ...
        /// Constructor
        _data_clusterer_w(Interface* _ptr) :
          base_type(_ptr) {
        }
      ...
      public:
        ...
        hard_cluster_on(hard_clustering_type& _hard_clustering,
                        ...
                        const uint _n_clusters) const {
          // Call
          this->ptr_->hard_cluster_on(_hard_clustering, _data, _n_clusters);
        }
        ...
        hard_cluster(const dt::wr::data_wrap& _data,
                     const uint _n_clusters) const {
          // Call
          return this->ptr_->hard_cluster(_data, _n_clusters);
        }
        ...
        soft_cluster_on(soft_clustering_type& _soft_clustering,
                        ...
                        const uint _n_clusters) const {
          // Call
          this->ptr_->soft_cluster_on(_soft_clustering, _data, _n_clusters);
        }
        ...
        soft_cluster(const dt::wr::data_wrap& _data,
                     const uint _n_clusters) const {
          // Call
          return this->ptr_->soft_cluster(_data, _n_clusters);
        }
      };

      /// Data clusterer wrapper
      template <typename Choices = tu::default_choices>
      class data_clusterer_w :
        public _data_clusterer_w< _data_clusterer_interface<Choices> > {
      private:
        /// Interface
        typedef _data_clusterer_interface<Choices> interface;
      ...
      public:
        ...
        /// Constructor
        template <typename T>
        data_clusterer_w(T* _value, bool _owned = true) :
          base_type(new _data_clusterer_referee<T, interface>(_value,
                                                              _owned)) {
        }

        /// Constructor
        template <typename T>
        data_clusterer_w(T& _value, bool _owned = false) :
          base_type(new _data_clusterer_referee<T, interface>(&_value,
                                                              _owned)) {
        }
      };
