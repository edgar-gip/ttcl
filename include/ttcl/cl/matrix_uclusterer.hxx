...
#ifndef TTCL_CL_MATRIX_UCLUSTERER_HXX
#define TTCL_CL_MATRIX_UCLUSTERER_HXX

/** @file
    Clustering - Matrix unsupervised clusterer
    ...
    public:
      ...
      */
      ...
      hard_cluster_on(hard_clustering_type& _hard_clustering,
                      const matrix_type& _in_distances) const = 0;
      ...
      */
      ...
      hard_cluster(const matrix_type& _in_distances) const {
        // Build and return
        hard_clustering_type ret(_in_distances.size());
        hard_cluster_on(ret, _in_distances);
        return ret;
      }
      ...
      */
      ...
      soft_cluster(const matrix_type& _in_distances) const {
        // Build and return
        soft_clustering_type ret(_in_distances.size(), 1 /* By default */);
        soft_cluster_on(ret, _in_distances);
        return ret;
      }
    };
  }
