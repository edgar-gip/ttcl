...
#ifndef TTCL_CL_DATA_UMODELER_HXX
#define TTCL_CL_DATA_UMODELER_HXX

/** @file
    Clustering - Data unsupervised modeler
...
namespace ttcl {
  ...
  namespace cl {
    ...
    public:
      ...
      */
      virtual model_type*
      model(const data_type& _data) const = 0;
      ...
      */
      ...
      hard_cluster_on(hard_clustering_type& _hard_clustering,
        ...
        model_type* ret = hard_model_on(_hard_clustering, _data);
        delete ret;
      }
      ...
      */
      ...
      soft_cluster_on(soft_clustering_type& _soft_clustering,
                      const data_type& _data) const {
        // Cluster using a model, and ignore it
        model_type* ret = soft_model_on(_soft_clustering, _data);
        delete ret;
      }
    };
  }
