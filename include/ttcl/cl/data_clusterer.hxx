...
#ifndef TTCL_CL_DATA_CLUSTERER_HXX
#define TTCL_CL_DATA_CLUSTERER_HXX

/** @file
    Clustering - Data clusterer
    ...
    public:
      ...
      */
      ...
      hard_cluster(const data_type& _data,
        ...
        // Build and return
        hard_clustering_type ret(_data.size(), _n_clusters);
        hard_cluster_on(ret, _data, _n_clusters);
        return ret;
      }
      ...
      */
      ...
      soft_cluster(const data_type& _data,
                   const uint _n_clusters) const {
        // Build and return
        soft_clustering_type ret(_data.size(), _n_clusters);
        soft_cluster_on(ret, _data, _n_clusters);
        return ret;
      }
    };
  }
