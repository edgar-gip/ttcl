...
namespace ttcl {
  ...
  namespace cl {
    ...
    /// Soft matrix unsupervised clusterer
    ...
    public:
      ...
      */
      ...
      hard_cluster_on(hard_clustering_type& _hard_clustering,
        ...
        // Assign
        _hard_clustering = this->soft_cluster(_in_distance);
      }
      ...
      */
      ...
      hard_cluster(const matrix_type& _in_distances) const {
        // Build and return
        return hard_clustering_type(this->soft_cluster(_in_distances));
      }
    };
  }
}
